...
public class RecommendationController {
	...
	// ==========================================
	// ĐÂY LÀ API BỊ THIẾU CHO TRANG ADMIN NÈ ĐỨC
	// ==========================================
	@GetMapping(value = "/admin/recommendations")
	public ResponseEntity<List<Recommendation>> getAllRecommendationsForAdmin() {
